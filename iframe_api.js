(function () {
    ...
    function getType(arg) {
        ...
        if ('object' == b)
            if (arg) {
                ...
                if ('[object Window]' == c)
                    return 'object';
                if ('[object Array]' == c || 'number' == typeof arg.length && 'undefined' != typeof arg.splice && 'undefined' != typeof arg.propertyIsEnumerable && !arg.propertyIsEnumerable('splice'))
                    return 'array';
                if ('[object Function]' == c || 'undefined' != typeof arg.call && 'undefined' != typeof arg.propertyIsEnumerable && !arg.propertyIsEnumerable('call'))
                    return 'function';
            } else
                return 'null';
        else if ('function' == b && 'undefined' == typeof arg.call)
            return 'object';
        return b;
    }
    ...
    var p = 'closure_uid_' + (1000000000 * Math.random() >>> 0), ca = 0;
    ...
    var ga = v.indexOf ? function (a, b, c) {
    ...
    var w = v.forEach ? function (a, b, c) {
    ...
    function ha(a, b) {
        ...
        t: {
            c = a.length;
            for (var d = isString(a) ? a.split('') : a, e = 0; e < c; e++)
    ...
    var D = function () {
            var a = '', b;
            if (z && self$.opera)
                return a = self$.opera.version, 'function' == getType(a) ? a() : a;
    ...
    var qa = self$.document, ra = qa && A ? oa() || ('CSS1Compat' == qa.compatMode ? parseInt(D, 10) : 5) : void 0;
    ...
    function Ma(a) {
        return a && window.yterr ? function () {
            try {
                ...
                d ? d(c, void 0) : (d = ('ERRORS' in J ? J.ERRORS : void 0) || [], d.push([
                    c,
                    void 0
                ]), Ka('ERRORS', d));
                throw b;
    ...
    function O(a, b, c) {
        ...
        this.M = {};
        b = document;
        if (a = isString(a) ? b.getElementById(a) : a)
    ...
    g.destroy = function () {
        ...
        if (this.o) {
            ...
            (a = this.d) && a.parentNode && a.parentNode.removeChild(a);
        Q && (Q[this.G] = null);
        this.g = null;
        var a = this.d, c;
        for (c in x)
    ...
    g.J = function (a) {
        ...
        f && (k += '//', e && (k += e + '@'), k += f, d && (k += ':' + d));
        c = k;
        b = 0 == c.indexOf('https:') ? [c] : b.d ? [c.replace('http:', 'https:')] : b.j ? [c] : [
            c,
    ...
    var db = 'StopIteration' in self$ ? self$.StopIteration : Error('StopIteration');
    function eb() {
    }
    ...
    function Tb(a) {
        ...
        this.defaults.width = 640;
        this.defaults.height = 0.67 * P(this, 'width');
    }
    s(Tb, X);
    function $(a, b) {
        var c = new Tb(b);
